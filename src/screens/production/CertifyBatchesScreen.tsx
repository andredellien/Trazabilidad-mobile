...
export default function CertifyBatchesScreen({ navigation }: any) {
  ...
  const pendingBatches = batches?.filter((batch: any) => batch.status === 'pending') || [];
  ...
  return (
    <View className="flex-1 bg-gray-50">
      <View className="px-4 py-3">
        <Text className="text-lg font-bold text-gray-800">Lotes Pendientes de Certificación</Text>
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View className="items-center py-16">
            ...
            <Text className="text-gray-500 text-center mt-4 font-medium">No hay lotes pendientes</Text>
            <Text className="text-gray-400 text-center text-sm mt-1">
              Los lotes listos para certificación aparecerán aquí
            </Text>
          </View>
        }
      />
